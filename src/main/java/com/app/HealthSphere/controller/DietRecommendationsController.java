...
//    }
//
//    // Get all recommendations by user ID (Accessible to both USER and ADMIN)
//    @GetMapping("/{userId}")
//    public ResponseEntity<List<DietRecommendations>> getDietRecommendationById(
//            @PathVariable int userId,
//            @RequestHeader("Role") String role) {
//        // Allow USER and ADMIN roles to access this data
//        if (!isUser(role) && !isAdmin(role)) {
//            return ResponseEntity.status(HttpStatus.FORBIDDEN).body(List.of());
//        }
//        List<DietRecommendations> dietRecommendations = dietRecommendationsService.findDietRecommendationById(userId);
...
//    }
//
//    // Retrieve all diet recommendations (User and Admin roles allowed)
//    @GetMapping
//    public ResponseEntity<Map<String, Object>> getAllDietRecommendations(@RequestHeader("Role") String role) {
//        // Allow both ADMIN and USER roles
//        if (!isUser(role) && !isAdmin(role)) {
//            return ResponseEntity.status(HttpStatus.FORBIDDEN).body(Map.of("error", "Access denied. Invalid role."));
//        }
//        List<DietRecommendations> dietRecommendations = dietRecommendationsService.findAllDietRecommendations();
//        return ResponseEntity.ok(Map.of("dietRecommendations", dietRecommendations));
//    }
